...
a+1)};window.addEventListener?window.addEventListener("keydown",b._onKeyDown,!0):document.attachEvent&&document.attachEvent("onkeydown",b._onKeyDown)}function t(){var a=document.querySelector(".widearea-overlayLayer");/dark/gi.test(a.className)?a.className=a.className.replace("dark","light"):a.className=a.className.replace("light","dark")}function q(){var a=document.querySelector("textarea.widearea-fullscreened"),b=document.querySelector(".widearea-overlayLayer"),c=b.querySelector("textarea");a.focus();
a.value=c.value;a.className=a.className.replace(/widearea-fullscreened/gi,"").replace(/^\s+|\s+$/g,"");b.parentNode.removeChild(b);window.removeEventListener?window.removeEventListener("keydown",this._onKeyDown,!0):document.detachEvent&&document.detachEvent("onkeydown",this._onKeyDown)}var m=function(a){if("string"===typeof a){if(a=document.querySelector(a))return new d(a);throw Error("There is no element with given selector.");}return new d(document.body)};m.version="0.3.0";m.fn=d.prototype={clone:function(){return new d(this)},
