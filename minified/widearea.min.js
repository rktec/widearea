(function(g,d){"object"===typeof exports?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(g)})(this,function(g){function d(a){this._targetElement=a;this._wideAreaId=1;this._options={wideAreaAttr:"data-widearea",exitOnEsc:!0,defaultColorScheme:"light",closeIconLabel:"Close WideArea",changeThemeIconLabel:"Toggle Color Scheme",fullScreenIconLabel:"WideArea Mode",autoSaveKeyPrefix:"WDATA-"+window.location.href+"-"};r.call(this)}function n(a,b){localStorage.setItem(this._options.autoSaveKeyPrefix+
